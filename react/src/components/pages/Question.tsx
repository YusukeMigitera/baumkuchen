    ...
    <div className="flex justify-center items-center flex-col pt-12 mb-32">
      <div className="w-1/2 h-1/4">
        <div className="w-full flex flex-col">
          <label className="font-semibold leading-none text-gray-700">
            Subject
          </label>
          <input
            type="text"
            className="leading-none text-gray-700 p-3 focus:outline-none focus:border-blue-700 mt-4 border-0 bg-gray-100 rounded"
          />
        </div>
        <div className="w-full flex flex-col mt-8">
          ...
          <textarea className="h-40 text-base leading-none text-gray-700 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-100 border-0 rounded"></textarea>
        </div>
        <div className="flex items-center justify-between mt-9 w-4/5 mx-auto flex-col gap-6">
